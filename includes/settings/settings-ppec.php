...
if ( $enable_ips && $needs_creds ) {
	...
	$api_creds_text = sprintf(
		...
		__( 'To reset current credentials and use another account %1$sclick here%2$s. %3$sLearn more about your API Credentials%2$s.', 'pp-express-wc4jp' ),
		'<a href="' . $reset_link . '" title="' . __( 'Reset current credentials', 'pp-express-wc4jp' ) . '">',
		'</a>',
		'<a href="https://docs.woocommerce.com/document/paypal-express-checkout/#section-4" title="' . __( 'Learn more', 'pp-express-wc4jp' ) . '">'
	);
}
...
if ( $enable_ips && $needs_sandbox_creds ) {
	...
	$sandbox_api_creds_text = sprintf(
		...
		__( 'Your account setting is set to sandbox, no real charging takes place. To accept live payments, switch your environment to live and connect your PayPal account. To reset current credentials and use other sandbox account %1$sclick here%2$s. %3$sLearn more about your API Credentials%2$s.', 'pp-express-wc4jp' ),
		'<a href="' . $reset_link . '" title="' . __( 'Reset current credentials', 'pp-express-wc4jp' ) . '">',
		'</a>',
		'<a href="https://docs.woocommerce.com/document/paypal-express-checkout/#section-4" title="' . __( 'Learn more', 'pp-express-wc4jp' ) . '">'
	);
...
$credit_enabled_label = __( 'Enable PayPal Credit to eligible customers', 'pp-express-wc4jp' );
if ( ! wc_gateway_ppec_is_credit_supported() ) {
	$credit_enabled_label .= '<p><em>' . __( 'This option is disabled. Currently PayPal Credit only available for U.S. merchants using USD currency.', 'pp-express-wc4jp' ) . '</em></p>';
}

$credit_enabled_description = __( 'This enables PayPal Credit, which displays a PayPal Credit button next to the primary PayPal Checkout button. PayPal Checkout lets you give customers access to financing through PayPal Credit® - at no additional cost to you. You get paid up front, even though customers have more time to pay. A pre-integrated payment button shows up next to the PayPal Button, and lets customers pay quickly with PayPal Credit®. (Should be unchecked for stores involved in Real Money Gaming.)', 'pp-express-wc4jp' );
